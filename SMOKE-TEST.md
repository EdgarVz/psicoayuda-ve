...
| 8 | WhatsApp link se muestra solo tras aprobación | ⬜ Sin cobertura |
| 9 | Perfil de psicólogo editable desde dashboard | ⬜ Sin cobertura |
| 10 | Admin puede verificar psicólogos | 🔵 Unit test (actions + components) |
| 11 | CSP headers presentes en response | ⬜ Sin cobertura |
| 12 | Rate limiting bloquea después de N requests | ⬜ Sin cobertura |
