...
## 2026-07-04 — Fix: dashboard vacío, navbar faltante, guard registro psicólogo
...
| Registro psicólogo permitía volver sin guard | Página pública sin verificación de perfil existente | `RegistroPsicologoPage` ahora es async, consulta `psychologist_profiles`, redirige a `/dashboard` si ya existe |
...
| `src/app/(public)/registro-psicologo/page.tsx` | Server Component async con guard de perfil existente |
